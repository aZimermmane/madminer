      SUBROUTINE M94_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M94_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M94_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M94_SMATRIX(P,ANS)
C     
...
C     
      ...
      COMMON/M94_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M94_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M94_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M94_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.
     $       -1.OR.M94_IS_BORN_HEL_SELECTED(IHEL)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M94_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.8.3.2, 2021-02-02
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV11_9P0_3(W(1,1),W(1,2),GC_736,GC_737,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV4_3(W(1,1),W(1,2),GC_933,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV2_8_0(W(1,4),W(1,5),W(1,7),GC_651,GC_660,AMP(12))
      CALL FFV11_9_3(W(1,1),W(1,2),GC_723,GC_724,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV2_8_0(W(1,4),W(1,5),W(1,7),GC_651,GC_660,AMP(13))
      CALL FFV2_3(W(1,1),W(1,2),GC_939,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 11
      CALL FFV2_8_0(W(1,4),W(1,5),W(1,7),GC_651,GC_660,AMP(14))
      CALL FFS4_3(W(1,1),W(1,2),GC_953,MDL_MH,MDL_WH,W(1,7))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV10_3_3(W(1,1),W(1,5),GC_741,GC_768,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_649,AMP(19))
      CALL FFV2_3(W(1,1),W(1,5),GC_649,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV4_3(W(1,1),W(1,5),GC_924,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_649,AMP(24))
      CALL FFV2_3(W(1,1),W(1,5),GC_740,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_649,AMP(25))
      JAMP(1)=-AMP(2)-1D0/2D0*AMP(3)+1D0/6D0*AMP(4)+AMP(5)+AMP(6)
     $ +AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)
     $ +AMP(15)+AMP(16)-1D0/6D0*AMP(17)-1D0/6D0*AMP(18)
      JAMP(2)=-AMP(1)+1D0/6D0*AMP(3)-1D0/2D0*AMP(4)+1D0/2D0*AMP(17)
     ...
     $ -AMP(25)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M94_MATRIX = M94_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M94_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE M94_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M94_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M94_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
