      SUBROUTINE M28_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M28_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M28_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M28_SMATRIX(P,ANS)
C     
...
C     
      ...
      COMMON/M28_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M28_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M28_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M28_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.
     $       -1.OR.M28_IS_BORN_HEL_SELECTED(IHEL)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M28_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.8.3.2, 2021-02-02
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      CALL FFFF11_2_6_0(W(1,4),W(1,2),W(1,1),W(1,5),GC_272,GC_247
     $ ,GC_167,AMP(1))
      CALL FFFF1_15_16_17_5_9_0(W(1,4),W(1,2),W(1,1),W(1,5),-GC_266,
     $ -GC_215,-GC_493,-GC_82,-GC_164,-GC_273,AMP(2))
      CALL FFFF11_2_0(W(1,4),W(1,2),W(1,1),W(1,5),GC_304,GC_279,AMP(3))
      CALL FFFF1_15_16_17_9_0(W(1,4),W(1,2),W(1,1),W(1,5),-GC_298,
     $ -GC_231,-GC_505,-GC_94,-GC_305,AMP(4))
      CALL FFV10_3P0_3(W(1,1),W(1,2),GC_862,GC_857,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_813,GC_814,AMP(6))
      CALL FFV2_4_3(W(1,1),W(1,2),GC_943,GC_935,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV10_3_3(W(1,1),W(1,2),GC_782,GC_777,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_8_0(W(1,4),W(1,5),W(1,7),GC_651,GC_660,AMP(11))
C     Amplitude(s) for diagram number 9
      CALL FFV4_0(W(1,4),W(1,5),W(1,7),GC_948,AMP(12))
C     Amplitude(s) for diagram number 10
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_721,GC_722,AMP(13))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,4),W(1,5),W(1,7),GC_938,AMP(14))
      CALL FFV10_3_3(W(1,1),W(1,5),GC_747,GC_866,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 12
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_767,GC_742,AMP(15))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_649,AMP(16))
C     Amplitude(s) for diagram number 14
      CALL FFV4_0(W(1,4),W(1,2),W(1,7),GC_923,AMP(17))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_740,AMP(18))
      CALL FFV2_4_3(W(1,1),W(1,5),GC_919,GC_930,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 16
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_767,GC_742,AMP(19))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_649,AMP(20))
C     Amplitude(s) for diagram number 18
      CALL FFV4_0(W(1,4),W(1,2),W(1,7),GC_923,AMP(21))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_740,AMP(22))
      JAMP(1)=-AMP(2)-1D0/2D0*AMP(3)+1D0/6D0*AMP(4)+AMP(5)+AMP(6)
     $ +AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)
      JAMP(2)=-AMP(1)+1D0/6D0*AMP(3)-1D0/2D0*AMP(4)-AMP(15)-AMP(16)
     $ -AMP(17)-AMP(18)-AMP(19)-AMP(20)-AMP(21)-AMP(22)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M28_MATRIX = M28_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M28_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE M28_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M28_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M28_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
