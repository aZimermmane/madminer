      SUBROUTINE M43_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M43_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M43_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M43_SMATRIX(P,ANS)
C     
...
C     
      ...
      COMMON/M43_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M43_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M43_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M43_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.
     $       -1.OR.M43_IS_BORN_HEL_SELECTED(IHEL)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M43_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.8.3.2, 2021-02-02
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      CALL FFFF11_2_6_0(W(1,4),W(1,2),W(1,1),W(1,5),GC_276,GC_251
     $ ,GC_173,AMP(1))
      CALL FFFF1_15_16_17_5_9_0(W(1,4),W(1,2),W(1,1),W(1,5),-GC_270,
     $ -GC_219,-GC_495,-GC_84,-GC_170,-GC_277,AMP(2))
      CALL FFFF11_2_0(W(1,4),W(1,2),W(1,1),W(1,5),GC_308,GC_283,AMP(3))
      CALL FFFF1_15_16_17_9_0(W(1,4),W(1,2),W(1,1),W(1,5),-GC_302,
     $ -GC_235,-GC_507,-GC_96,-GC_309,AMP(4))
      CALL FFV10_3P0_3(W(1,1),W(1,2),GC_864,GC_859,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_813,GC_814,AMP(6))
      CALL FFV2_4_3(W(1,1),W(1,2),GC_947,GC_937,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV10_3_3(W(1,1),W(1,2),GC_784,GC_779,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV10_3_3(W(1,1),W(1,5),GC_749,GC_868,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV2_4_3(W(1,1),W(1,5),GC_921,GC_932,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 19
     ...
     $ -AMP(17)-AMP(18)-AMP(19)-AMP(20)-AMP(21)-AMP(22)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M43_MATRIX = M43_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M43_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE M43_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M43_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M43_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
