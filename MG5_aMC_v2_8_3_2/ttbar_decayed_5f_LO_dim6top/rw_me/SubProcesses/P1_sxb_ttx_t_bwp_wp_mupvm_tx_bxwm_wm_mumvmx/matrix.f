      SUBROUTINE M83_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M83_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M83_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M83_SMATRIX(P,ANS)
C     
...
C     
      ...
      COMMON/M83_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M83_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M83_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M83_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.
     $       -1.OR.M83_IS_BORN_HEL_SELECTED(IHEL)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M83_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.8.3.2, 2021-02-02
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      CALL FFFF11_2_6_0(W(1,4),W(1,1),W(1,2),W(1,5),GC_252,GC_275
     $ ,GC_174,AMP(1))
      CALL FFFF1_15_16_17_5_9_0(W(1,4),W(1,1),W(1,2),W(1,5),-GC_278,
     $ -GC_220,-GC_496,-GC_85,-GC_169,-GC_269,AMP(2))
      CALL FFFF11_2_0(W(1,4),W(1,1),W(1,2),W(1,5),GC_284,GC_307,AMP(3))
      CALL FFFF1_15_16_17_9_0(W(1,4),W(1,1),W(1,2),W(1,5),-GC_310,
     $ -GC_236,-GC_508,-GC_97,-GC_301,AMP(4))
      CALL FFV10_3P0_3(W(1,2),W(1,1),GC_860,GC_863,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_813,GC_814,AMP(6))
      CALL FFV2_4_3(W(1,2),W(1,1),GC_945,GC_936,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV10_3_3(W(1,2),W(1,1),GC_780,GC_783,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV10_3_3(W(1,4),W(1,1),GC_867,GC_750,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV2_4_3(W(1,4),W(1,1),GC_922,GC_931,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 19
     ...
     $ +AMP(17)+AMP(18)+AMP(19)+AMP(20)+AMP(21)+AMP(22)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M83_MATRIX = M83_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M83_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE M83_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M83_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M83_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
