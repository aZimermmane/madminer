      SUBROUTINE M69_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M69_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M69_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M69_SMATRIX(P,ANS)
C     
...
C     
      ...
      COMMON/M69_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M69_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M69_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M69_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.
     $       -1.OR.M69_IS_BORN_HEL_SELECTED(IHEL)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M69_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.8.3.2, 2021-02-02
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      CALL FFFF11_2_6_0(W(1,4),W(1,1),W(1,2),W(1,5),GC_248,GC_271
     $ ,GC_168,AMP(1))
      CALL FFFF1_15_16_17_5_9_0(W(1,4),W(1,1),W(1,2),W(1,5),-GC_274,
     $ -GC_216,-GC_494,-GC_83,-GC_163,-GC_265,AMP(2))
      CALL FFFF11_2_0(W(1,4),W(1,1),W(1,2),W(1,5),GC_280,GC_303,AMP(3))
      CALL FFFF1_15_16_17_9_0(W(1,4),W(1,1),W(1,2),W(1,5),-GC_306,
     $ -GC_232,-GC_506,-GC_95,-GC_297,AMP(4))
      CALL FFV10_3P0_3(W(1,2),W(1,1),GC_858,GC_861,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_813,GC_814,AMP(6))
      CALL FFV2_4_3(W(1,2),W(1,1),GC_941,GC_934,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV10_3_3(W(1,2),W(1,1),GC_778,GC_781,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV10_3_3(W(1,4),W(1,1),GC_865,GC_748,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 12
      CALL FFV10_3_0(W(1,2),W(1,5),W(1,7),GC_741,GC_768,AMP(15))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,2),W(1,5),W(1,7),GC_649,AMP(16))
C     Amplitude(s) for diagram number 14
      CALL FFV4_0(W(1,2),W(1,5),W(1,7),GC_924,AMP(17))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,2),W(1,5),W(1,7),GC_740,AMP(18))
      CALL FFV2_4_3(W(1,4),W(1,1),GC_920,GC_929,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 16
      CALL FFV10_3_0(W(1,2),W(1,5),W(1,7),GC_741,GC_768,AMP(19))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,2),W(1,5),W(1,7),GC_649,AMP(20))
C     Amplitude(s) for diagram number 18
      CALL FFV4_0(W(1,2),W(1,5),W(1,7),GC_924,AMP(21))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,2),W(1,5),W(1,7),GC_740,AMP(22))
     ...
     $ +AMP(17)+AMP(18)+AMP(19)+AMP(20)+AMP(21)+AMP(22)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M69_MATRIX = M69_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M69_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE M69_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M69_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M69_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
