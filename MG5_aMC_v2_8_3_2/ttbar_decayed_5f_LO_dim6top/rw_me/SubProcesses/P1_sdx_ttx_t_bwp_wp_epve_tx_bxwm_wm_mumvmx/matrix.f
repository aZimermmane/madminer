      SUBROUTINE M34_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M34_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M34_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M34_SMATRIX(P,ANS)
C     
...
C     
      ...
      COMMON/M34_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M34_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M34_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M34_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.
     $       -1.OR.M34_IS_BORN_HEL_SELECTED(IHEL)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M34_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.8.3.2, 2021-02-02
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_865,GC_748,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_920,GC_929,AMP(2))
      CALL FFV2_4_3(W(1,1),W(1,5),GC_921,GC_932,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_865,GC_748,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_920,GC_929,AMP(4))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M34_MATRIX = M34_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M34_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE M34_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M34_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M34_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
