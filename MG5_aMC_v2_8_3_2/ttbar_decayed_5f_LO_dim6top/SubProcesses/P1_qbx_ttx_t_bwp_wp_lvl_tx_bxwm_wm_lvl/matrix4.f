...
C     Amplitude(s) for diagram number 1
     ...
     $ -GC_236,-GC_508,-GC_97,-GC_301,AMP(4))
      CALL FFV10_3P0_3(W(1,2),W(1,1),GC_860,GC_863,ZERO, FK_ZERO,W(1,7)
     $ )
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_813,GC_814,AMP(6))
      CALL FFV2_4_3(W(1,2),W(1,1),GC_945,GC_936,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV10_3_3(W(1,2),W(1,1),GC_780,GC_783,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV10_3_3(W(1,4),W(1,1),GC_867,GC_750,MDL_MW, ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV2_4_3(W(1,4),W(1,1),GC_922,GC_931,MDL_MW, ZERO,W(1,7))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -AMP(7)-AMP(8)-AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(13)-AMP(14)
      JAMP(2,1)=+AMP(1)-1D0/6D0*AMP(3)+1D0/2D0*AMP(4)+AMP(15)+AMP(16)
     ...
     $ +AMP(20)+AMP(21)+AMP(22))*DCONJG(AMP(15)+AMP(16)+AMP(17)+AMP(18)
