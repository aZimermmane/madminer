...
C     Amplitude(s) for diagram number 1
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_753,GC_758,AMP(1))
      CALL FFV2_4_3(W(1,1),W(1,5),GC_942,GC_950,MDL_MZ, ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_944,GC_951,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_771,GC_776,AMP(3))
      CALL FFV10_3_3(W(1,1),W(1,5),GC_773,GC_770,MDL_MZ, ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_944,GC_951,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_771,GC_776,AMP(5))
      CALL FFS1_3_3(W(1,1),W(1,5),GC_912,GC_915,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFS1_3_0(W(1,4),W(1,2),W(1,7),GC_918,GC_913,AMP(6))
      CALL FFV10_3P0_3(W(1,1),W(1,5),GC_801,GC_798,ZERO, FK_ZERO,W(1,7)
     $ )
C     Amplitude(s) for diagram number 7
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_799,GC_804,AMP(7))
