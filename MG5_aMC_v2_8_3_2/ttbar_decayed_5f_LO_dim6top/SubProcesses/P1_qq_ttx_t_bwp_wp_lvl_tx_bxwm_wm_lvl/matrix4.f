...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1D0/6D0*AMP(6)+AMP(7)+AMP(8)+AMP(9)+AMP(10)-1D0/2D0*AMP(17)
      JAMP(2,1)=+1D0/2D0*AMP(2)+1D0/2D0*AMP(5)+1D0/2D0*AMP(6)-AMP(11)
     ...
     $ +AMP(16))*DCONJG(AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)+AMP(16)
     $ )
