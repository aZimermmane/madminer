...
C     Amplitude(s) for diagram number 1
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_751,GC_756,AMP(1))
      CALL FFV2_4_3(W(1,1),W(1,5),GC_946,GC_952,MDL_MZ, ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_940,GC_949,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_769,GC_774,AMP(3))
      CALL FFV10_3_3(W(1,1),W(1,5),GC_775,GC_772,MDL_MZ, ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_940,GC_949,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_769,GC_774,AMP(5))
      CALL FFS1_3_3(W(1,1),W(1,5),GC_914,GC_917,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFS1_3_0(W(1,4),W(1,2),W(1,7),GC_916,GC_911,AMP(6))
      CALL FFV10_3P0_3(W(1,1),W(1,5),GC_803,GC_800,ZERO, FK_ZERO,W(1,7)
     $ )
C     Amplitude(s) for diagram number 7
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_797,GC_802,AMP(7))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(-AMP(7))
      JAMP(2,1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)+1D0/6D0
     $ *AMP(7)
     ...
     $ *DCONJG(AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6))
