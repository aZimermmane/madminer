...
C     
      ...
      TMP15 = (P3(0)*V2(3)-P3(1)*V2(4)-P3(2)*V2(5)-P3(3)*V2(6))
      TMP16 = (V3(3)*V2(3)-V3(4)*V2(4)-V3(5)*V2(5)-V3(6)*V2(6))
      DENOM = COUP/(P1(0)**2-P1(1)**2-P1(2)**2-P1(3)**2 - M1 * (M1 -CI
     $ * W1))
      V1(3)= DENOM*(TMP16*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI*(TMP12)
     $ +CI*(TMP13))+V3(3)*(+CI*(TMP14)-CI*(TMP15))))
      V1(4)= DENOM*(TMP16*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(-CI*(TMP12)
     $ +CI*(TMP13))+V3(4)*(+CI*(TMP14)-CI*(TMP15))))
      V1(5)= DENOM*(TMP16*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(-CI*(TMP12)
     $ +CI*(TMP13))+V3(5)*(+CI*(TMP14)-CI*(TMP15))))
      V1(6)= DENOM*(TMP16*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(-CI*(TMP12)
     $ +CI*(TMP13))+V3(6)*(+CI*(TMP14)-CI*(TMP15))))
      END
