...
C     Amplitude(s) for diagram number 1
      CALL FFFF18_0(W(1,1),W(1,2),W(1,4),W(1,5),GC_590,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_7,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV11_0(W(1,4),W(1,5),W(1,7),GC_725,AMP(4))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
C     Amplitude(s) for diagram number 5
      CALL FFV2_8_0(W(1,4),W(1,5),W(1,7),-GC_650,GC_660,AMP(5))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-1D0/6D0*AMP(1)+AMP(2)-1D0/6D0*AMP(3)-1D0/6D0*AMP(4)
     $ +AMP(5)
      JAMP(2,1)=+1D0/2D0*(+AMP(1)+AMP(3)+AMP(4))
