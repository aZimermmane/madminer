...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV11_1(W(1,5),W(1,1),GC_725,MDL_MT,MDL_WT,W(1,7))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV11_2(W(1,4),W(1,1),GC_725,MDL_MT,MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV6_0(W(1,7),W(1,5),W(1,2),GC_7,AMP(9))
      JAMP(1)=-IMAG1*AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(3)+AMP(4)+AMP(5)
     $ +AMP(6)
      JAMP(2)=+IMAG1*AMP(1)+IMAG1*AMP(2)+IMAG1*AMP(3)+AMP(7)+AMP(8)
     $ +AMP(9)
