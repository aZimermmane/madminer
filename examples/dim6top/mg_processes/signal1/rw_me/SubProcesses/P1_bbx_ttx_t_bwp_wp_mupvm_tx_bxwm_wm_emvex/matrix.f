...
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(1))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_650,GC_660,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV2_8_0(W(1,4),W(1,5),W(1,7),-GC_650,GC_660,AMP(2))
      CALL FFS4_3(W(1,1),W(1,2),GC_953,MDL_MH,MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFS4_0(W(1,4),W(1,5),W(1,7),GC_954,AMP(3))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV11_0(W(1,4),W(1,5),W(1,7),GC_725,AMP(5))
      CALL FFV2_3(W(1,1),W(1,5),GC_649,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_649,AMP(6))
      JAMP(1)=+AMP(1)+AMP(2)+AMP(3)-1D0/6D0*AMP(4)-1D0/6D0*AMP(5)
      JAMP(2)=+1D0/2D0*AMP(4)+1D0/2D0*AMP(5)-AMP(6)
