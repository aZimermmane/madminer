...
C     Amplitude(s) for diagram number 1
      CALL FFVV4_0(W(1,4),W(1,5),W(1,1),W(1,2),GC_727,AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_7,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV11_0(W(1,4),W(1,5),W(1,7),GC_725,AMP(3))
      CALL FFV6_1(W(1,5),W(1,1),GC_7,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV6_0(W(1,4),W(1,7),W(1,2),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV11_0(W(1,4),W(1,7),W(1,2),GC_725,AMP(5))
      CALL FFV11_1(W(1,5),W(1,1),GC_725,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV6_0(W(1,4),W(1,7),W(1,2),GC_7,AMP(6))
      CALL FFV6_2(W(1,4),W(1,1),GC_7,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV6_0(W(1,7),W(1,5),W(1,2),GC_7,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV11_0(W(1,7),W(1,5),W(1,2),GC_725,AMP(8))
      CALL FFV11_2(W(1,4),W(1,1),GC_725,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV6_0(W(1,7),W(1,5),W(1,2),GC_7,AMP(9))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-IMAG1*AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(3)+AMP(4)+AMP(5)
     $ +AMP(6)
      JAMP(2,1)=+IMAG1*AMP(1)+IMAG1*AMP(2)+IMAG1*AMP(3)+AMP(7)+AMP(8)
     $ +AMP(9)
     ...
     $ +AMP(6))
      AMP2(7)=AMP2(7)+(AMP(7)+AMP(8)+AMP(9))*DCONJG(AMP(7)+AMP(8)
     $ +AMP(9))
      DO I = 1, NCOLOR
        DO M = 1, NAMPSO
          DO N = 1, NAMPSO
