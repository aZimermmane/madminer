...
C     
      ...
      COMPLEX*16 V4(*)
      COMPLEX*16 VERTEX
      TMP10 = (F1(3)*(F2(3)*(V3(3)*(V4(3)-V4(6))+(V3(4)*(-V4(4)+CI
     ...
     $ +CI*(V4(4))-V4(5))-V3(6)*(V4(3)+V4(6)))))))
      TMP11 = (F1(5)*(F2(5)*(V3(3)*(V4(3)-V4(6))+(V3(4)*(-1D0)*(V4(4)
     ...
     $ -1D0)*(+CI*(V4(4))+V4(5))-V3(6)*(V4(3)+V4(6)))))))
      TMP12 = (F1(5)*(F2(5)*(V3(3)*(V4(3)+V4(6))+(V3(4)*(-V4(4)+CI
     $ *(V4(5)))+(V3(5)*(-1D0)*(+CI*(V4(4))+V4(5))-V3(6)*(V4(3)+V4(6)))
     ...
     $ -1D0)*(+CI*(V4(4))+V4(5))+V3(6)*(V4(3)-V4(6)))))))
      VERTEX = COUP*(-CI*(TMP9+TMP11)+CI*(TMP10+TMP12))
      END
