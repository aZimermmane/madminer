...
C     ----------
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_649,MDL_MW,MDL_WW,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MB,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV2_1(W(1,4),W(1,5),GC_649,MDL_MT,MDL_WT,W(1,3))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,4))
      CALL IXXXXX(P(0,7),ZERO,NHEL(7),-1*IC(7),W(1,5))
      CALL FFV2_3(W(1,5),W(1,4),GC_649,MDL_MW,MDL_WW,W(1,6))
      CALL IXXXXX(P(0,8),MDL_MB,NHEL(8),-1*IC(8),W(1,5))
      CALL FFV2_2(W(1,5),W(1,6),GC_649,MDL_MT,MDL_WT,W(1,4))
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(6)-AMP(7)
      JAMP(2)=-IMAG1*AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(3)-AMP(8)-AMP(9)
     $ -AMP(10)-AMP(11)
