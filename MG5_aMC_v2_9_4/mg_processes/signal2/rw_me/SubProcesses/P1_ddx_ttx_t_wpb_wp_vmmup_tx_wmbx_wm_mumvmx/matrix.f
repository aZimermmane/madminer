...
C     ----------
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO,ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_5_3(W(1,1),W(1,2),GC_650,GC_660,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_8_0(W(1,4),W(1,3),W(1,5),-GC_650,GC_660,AMP(4))
      JAMP(1)=-AMP(1)+1D0/6D0*AMP(2)+1D0/6D0*AMP(3)-AMP(4)
      JAMP(2)=+1D0/2D0*(-AMP(2)-AMP(3))
