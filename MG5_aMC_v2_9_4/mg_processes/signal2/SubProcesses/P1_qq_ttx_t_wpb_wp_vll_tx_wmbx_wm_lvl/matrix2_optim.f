...
C     
C     Process: d d~ > t t~ NP<=1 @1
C     *   Decay: t > w+ b NP=0
C     *     Decay: w+ > ve e+ NP=0
C     *   Decay: t~ > w- b~ NP=0
C     *     Decay: w- > e- ve~ NP=0
C     Process: s s~ > t t~ NP<=1 @1
C     *   Decay: t > w+ b NP=0
C     *     Decay: w+ > ve e+ NP=0
C     *   Decay: t~ > w- b~ NP=0
C     *     Decay: w- > e- ve~ NP=0
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_1(W(1,8),W(1,7),GC_649,MDL_MT, FK_MDL_WT,W(1,10)) ! count 16
      CALL FFV2_1(W(1,9),W(1,7),GC_649,MDL_MT, FK_MDL_WT,W(1,11)) ! count 16
      ...
      CALL FFV2_2(W(1,15),W(1,14),GC_649,MDL_MT, FK_MDL_WT,W(1,17)) ! count 16
      CALL FFV2_2(W(1,16),W(1,14),GC_649,MDL_MT, FK_MDL_WT,W(1,18)) ! count 16
     ...
     & TMP, W, AMP(1,4)) ! count 1
      DO K = 1, NCOMB
        ...
        TMP_JAMP(1) = AMP( K,2) +  AMP( K,3)  ! used 2 times
        JAMP(1,1) = (-1.000000000000000D+00)*AMP( K,1)+(-1.0000000000000
     $  00D +00)*AMP( K,4)+(1.666666666666667D-01)*TMP_JAMP(1)
        JAMP(2,1) = (-5.000000000000000D-01)*TMP_JAMP(1)
