...
C     Amplitude(s) for diagram number 1
      CALL FFFF19_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_593,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,4),W(1,3),W(1,5),GC_7,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV11_0(W(1,4),W(1,3),W(1,5),GC_725,AMP(4))
      CALL FFV2_8_3(W(1,1),W(1,2),-GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1
     $ ,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_8_0(W(1,4),W(1,3),W(1,5),-GC_650,GC_660,AMP(5))
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(1) = AMP(1) +  AMP(3)  ! used 2 times
      TMP_JAMP(2) = TMP_JAMP(1) +  AMP(4)  ! used 2 times
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(2)+(-1.000000000000000D
     $ +00)*AMP(5)+(1.666666666666667D-01)*TMP_JAMP(2)
