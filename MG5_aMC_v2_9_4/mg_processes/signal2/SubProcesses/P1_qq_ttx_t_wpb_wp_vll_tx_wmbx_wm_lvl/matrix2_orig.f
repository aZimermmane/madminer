...
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(1))
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_8_0(W(1,4),W(1,3),W(1,5),-GC_650,GC_660,AMP(4))
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(1) = AMP(2) +  AMP(3)  ! used 2 times
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(1)+(-1.000000000000000D
     $ +00)*AMP(4)+(1.666666666666667D-01)*TMP_JAMP(1)
