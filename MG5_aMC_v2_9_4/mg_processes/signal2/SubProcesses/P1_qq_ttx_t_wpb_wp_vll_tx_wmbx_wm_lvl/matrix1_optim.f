...
C     
C     Process: u u~ > t t~ NP<=1 @1
C     *   Decay: t > w+ b NP=0
C     *     Decay: w+ > ve e+ NP=0
C     *   Decay: t~ > w- b~ NP=0
C     *     Decay: w- > e- ve~ NP=0
C     Process: c c~ > t t~ NP<=1 @1
C     *   Decay: t > w+ b NP=0
C     *     Decay: w+ > ve e+ NP=0
C     *   Decay: t~ > w- b~ NP=0
C     *     Decay: w- > e- ve~ NP=0
...
C     
      ...
      PARAMETER (NWAVEFUNCS=24, NCOLOR=2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_1(W(1,8),W(1,7),GC_649,MDL_MT, FK_MDL_WT,W(1,10)) ! count 18
      CALL FFV2_1(W(1,9),W(1,7),GC_649,MDL_MT, FK_MDL_WT,W(1,11)) ! count 18
      ...
      CALL FFV2_2(W(1,15),W(1,14),GC_649,MDL_MT, FK_MDL_WT,W(1,17)) ! count 18
      CALL FFV2_2(W(1,16),W(1,14),GC_649,MDL_MT, FK_MDL_WT,W(1,18)) ! count 18
      CALL FFFF19P1N_3(W(1,1), W(1,4), W(1,10), GC_593, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFFF19P1N_3(W(1,1), W(1,4), W(1,11), GC_593, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     ...
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_7,ZERO, FK_ZERO,W(1,21)) ! count 8
      CALL FFV1P0_3(W(1,2),W(1,3),GC_7,ZERO, FK_ZERO,W(1,22)) ! count 8
     ...
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFV11P1N_1(W(1,10), W(1,21), GC_725, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,4))
     ...
     & (/17,18/),
     & TMP, W, AMP(1,4))
      CALL FFV11P1N_1(W(1,11), W(1,21), GC_725, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,4))
     ...
     & TMP, W, AMP(1,4)) ! count 1
      CALL FFV2_8_3(W(1,1),W(1,4),-GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,23)) ! count 4
      CALL FFV2_8_3(W(1,2),W(1,3),-GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,24)) ! count 4
      CALL FFV2_8P1N_1(W(1,10), W(1,23), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,5))
      CALL FFV2_8P1N_1(W(1,10), W(1,24), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/17,18/),
     & TMP, W, AMP(1,5))
      CALL FFV2_8P1N_1(W(1,11), W(1,23), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,5))
      CALL FFV2_8P1N_1(W(1,11), W(1,24), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/17,18/),
     & TMP, W, AMP(1,5)) ! count 1
      DO K = 1, NCOMB
        ...
        TMP_JAMP(1) = AMP( K,1) +  AMP( K,3)  ! used 2 times
        TMP_JAMP(2) = TMP_JAMP(1) +  AMP( K,4)  ! used 2 times
        JAMP(1,1) = (-1.000000000000000D+00)*AMP( K,2)+(-1.0000000000000
     $  00D +00)*AMP( K,5)+(1.666666666666667D-01)*TMP_JAMP(2)
        JAMP(2,1) = (-5.000000000000000D-01)*TMP_JAMP(2)
