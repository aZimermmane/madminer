...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1)) ! count 13
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2)) ! count 13
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3)) ! count 69
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 69
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,5)) ! count 1
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,6)) ! count 1
      CALL FFV2_3(W(1,6),W(1,5),GC_649,MDL_MW, FK_MDL_WW,W(1,7)) ! count 2
      CALL OXXXXX(P(0,5),MDL_MB,+1,+1*IC(5),W(1,8)) ! count 1
      CALL OXXXXX(P(0,5),MDL_MB,-1,+1*IC(5),W(1,9)) ! count 1
      CALL FFV2_1(W(1,8),W(1,7),GC_649,MDL_MT, FK_MDL_WT,W(1,10)) ! count 48
      CALL FFV2_1(W(1,9),W(1,7),GC_649,MDL_MT, FK_MDL_WT,W(1,11)) ! count 48
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,12)) ! count 1
      CALL IXXXXX(P(0,7),ZERO,+1,-1*IC(7),W(1,13)) ! count 1
      CALL FFV2_3(W(1,13),W(1,12),GC_649,MDL_MW, FK_MDL_WW,W(1,14)) ! count 2
      CALL IXXXXX(P(0,8),MDL_MB,+1,-1*IC(8),W(1,15)) ! count 1
      CALL IXXXXX(P(0,8),MDL_MB,-1,-1*IC(8),W(1,16)) ! count 1
      CALL FFV2_2(W(1,15),W(1,14),GC_649,MDL_MT, FK_MDL_WT,W(1,17)) ! count 48
      CALL FFV2_2(W(1,16),W(1,14),GC_649,MDL_MT, FK_MDL_WT,W(1,18)) ! count 48
      CALL FFVV4P1N_1(W(1,10), W(1,1), W(1,3), GC_727, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFVV4P1N_1(W(1,10), W(1,2), W(1,4), GC_727, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFVV4P1N_1(W(1,11), W(1,1), W(1,3), GC_727, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFVV4P1N_1(W(1,11), W(1,2), W(1,4), GC_727, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL VVV1P0_1(W(1,1),W(1,3),GC_6,ZERO, FK_ZERO,W(1,19)) ! count 8
      CALL VVV1P0_1(W(1,2),W(1,4),GC_6,ZERO, FK_ZERO,W(1,22)) ! count 8
      CALL FFV6P1N_1(W(1,10), W(1,19), GC_7, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/17,18/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,10), W(1,22), GC_7, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,11), W(1,19), GC_7, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/17,18/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,11), W(1,22), GC_7, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV11P1N_1(W(1,10), W(1,19), GC_725, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/17,18/),
     & TMP, W, AMP(1,3))
      CALL FFV11P1N_1(W(1,10), W(1,22), GC_725, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,3))
      CALL FFV11P1N_1(W(1,11), W(1,19), GC_725, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/17,18/),
     & TMP, W, AMP(1,3))
      CALL FFV11P1N_1(W(1,11), W(1,22), GC_725, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFV6_1(W(1,10),W(1,1),GC_7,MDL_MT, ZERO,W(1,23)) ! count 8
      CALL FFV6_1(W(1,10),W(1,2),GC_7,MDL_MT, ZERO,W(1,24)) ! count 8
      CALL FFV6_1(W(1,11),W(1,1),GC_7,MDL_MT, ZERO,W(1,25)) ! count 8
      CALL FFV6_1(W(1,11),W(1,2),GC_7,MDL_MT, ZERO,W(1,26)) ! count 8
      CALL FFV6P1N_2(W(1,17), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,4))
      CALL FFV6P1N_2(W(1,17), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/11,3,9,1/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,4))
      CALL FFV6P1N_2(W(1,18), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/16,8,14,6/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,4))
      CALL FFV6P1N_2(W(1,18), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/12,4,10,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,4)) ! count 1
      CALL FFV11P1N_2(W(1,17), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))
      CALL FFV11P1N_2(W(1,17), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/11,3,9,1/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))
      CALL FFV11P1N_2(W(1,18), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/16,8,14,6/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))
      CALL FFV11P1N_2(W(1,18), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/12,4,10,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV11_1(W(1,10),W(1,1),GC_725,MDL_MT, ZERO,W(1,27)) ! count 8
      CALL FFV11_1(W(1,10),W(1,2),GC_725,MDL_MT, ZERO,W(1,28)) ! count 8
      CALL FFV11_1(W(1,11),W(1,1),GC_725,MDL_MT, ZERO,W(1,29)) ! count 8
      CALL FFV11_1(W(1,11),W(1,2),GC_725,MDL_MT, ZERO,W(1,30)) ! count 8
      CALL FFV6P1N_2(W(1,17), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/27,28,29,30/),
     ...
     & TMP, W, AMP(1,7)) ! count 1
      CALL FFV6_2(W(1,17),W(1,1),GC_7,MDL_MT, ZERO,W(1,31)) ! count 8
      CALL FFV6_2(W(1,17),W(1,2),GC_7,MDL_MT, ZERO,W(1,32)) ! count 8
      CALL FFV6_2(W(1,18),W(1,1),GC_7,MDL_MT, ZERO,W(1,33)) ! count 8
      CALL FFV6_2(W(1,18),W(1,2),GC_7,MDL_MT, ZERO,W(1,34)) ! count 8
      CALL FFV6P1N_1(W(1,10), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,8))
      CALL FFV6P1N_1(W(1,10), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/11,3,12,4/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,8))
      CALL FFV6P1N_1(W(1,11), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/13,5,14,6/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,8))
      CALL FFV6P1N_1(W(1,11), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/9,1,10,2/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,8)) ! count 1
      CALL FFV11P1N_1(W(1,10), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,9))
      CALL FFV11P1N_1(W(1,10), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/11,3,12,4/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,9))
      CALL FFV11P1N_1(W(1,11), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/13,5,14,6/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,9))
      CALL FFV11P1N_1(W(1,11), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/9,1,10,2/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,9)) ! count 1
      CALL FFV11_2(W(1,17),W(1,1),GC_725,MDL_MT, ZERO,W(1,35)) ! count 8
      CALL FFV11_2(W(1,17),W(1,2),GC_725,MDL_MT, ZERO,W(1,36)) ! count 8
      CALL FFV11_2(W(1,18),W(1,1),GC_725,MDL_MT, ZERO,W(1,37)) ! count 8
      CALL FFV11_2(W(1,18),W(1,2),GC_725,MDL_MT, ZERO,W(1,38)) ! count 8
      CALL FFV6P1N_1(W(1,10), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/35,36,37,38/),
     ...
     & TMP, W, AMP(1,11)) ! count 1
      DO K = 1, NCOMB
        ...
        JAMP(1,1) = (-1.000000000000000D+00)*AMP( K,4)+(-1.0000000000000
     $  00D +00)*AMP( K,5)+(-1.000000000000000D+00)*AMP( K,6)+( -1.0000000000000
     $  00D+00)*AMP( K,7)+((0.000000000000000D+00 ,1.000000000000000D+00))*TMP_J
     $  AMP(2)
        JAMP(2,1) = (-1.000000000000000D+00)*AMP( K,8)+(-1.0000000000000
     $  00D +00)*AMP( K,9)+(-1.000000000000000D+00)*AMP( K,10)+( -1.000000000000
     $  000D+00)*AMP( K,11)+((0.000000000000000D+00, -1.000000000000000D+00))*TM
     $  P_JAMP(2)
        ...
        IF(SDE_STRAT.EQ.1)THEN
          AMP2(2)=AMP2(2)+(AMP( K,2)+AMP( K,3))*DCONJG(AMP( K,2)+AMP( K,
     $    3))
          AMP2(4)=AMP2(4)+(AMP( K,4)+AMP( K,5)+AMP( K,6)+AMP( K,7))*DCON
     $    JG(AMP( K,4)   +AMP( K,5)+AMP( K,6)+AMP( K,7))
          AMP2(8)=AMP2(8)+(AMP( K,8)+AMP( K,9)+AMP( K,10)+AMP( K,11))*DC
     $    ONJG(AMP( K,8)   +AMP( K,9)+AMP( K,10)+AMP( K,11))
        ENDIF
