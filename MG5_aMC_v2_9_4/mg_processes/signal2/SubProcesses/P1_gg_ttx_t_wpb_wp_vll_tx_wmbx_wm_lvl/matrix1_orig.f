...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_649,MDL_MW, FK_MDL_WW,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MB,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV2_1(W(1,4),W(1,5),GC_649,MDL_MT, FK_MDL_WT,W(1,3))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,4))
      CALL IXXXXX(P(0,7),ZERO,NHEL(7),-1*IC(7),W(1,5))
      CALL FFV2_3(W(1,5),W(1,4),GC_649,MDL_MW, FK_MDL_WW,W(1,6))
      CALL IXXXXX(P(0,8),MDL_MB,NHEL(8),-1*IC(8),W(1,5))
      CALL FFV2_2(W(1,5),W(1,6),GC_649,MDL_MT, FK_MDL_WT,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFVV4_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_727,AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,3),W(1,5),GC_7,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV11_0(W(1,4),W(1,3),W(1,5),GC_725,AMP(3))
      CALL FFV6_1(W(1,3),W(1,1),GC_7,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV6_0(W(1,4),W(1,5),W(1,2),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV11_0(W(1,4),W(1,5),W(1,2),GC_725,AMP(5))
      CALL FFV11_1(W(1,3),W(1,1),GC_725,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV6_0(W(1,4),W(1,5),W(1,2),GC_7,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV11_0(W(1,4),W(1,5),W(1,2),GC_725,AMP(7))
      CALL FFV6_2(W(1,4),W(1,1),GC_7,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFV6_0(W(1,5),W(1,3),W(1,2),GC_7,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV11_0(W(1,5),W(1,3),W(1,2),GC_725,AMP(9))
      CALL FFV11_2(W(1,4),W(1,1),GC_725,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 10
      CALL FFV6_0(W(1,5),W(1,3),W(1,2),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV11_0(W(1,5),W(1,3),W(1,2),GC_725,AMP(11))
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(7)+((0.000000000000000D+00
     $ ,1.000000000000000D+00))*TMP_JAMP(2)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(8)+(-1.000000000000000D
     $ +00)*AMP(9)+(-1.000000000000000D+00)*AMP(10)+(
     $ -1.000000000000000D+00)*AMP(11)+((0.000000000000000D+00,
     $ -1.000000000000000D+00))*TMP_JAMP(2)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(4)=AMP2(4)+(AMP(4)+AMP(5)+AMP(6)+AMP(7))*DCONJG(AMP(4)
     $   +AMP(5)+AMP(6)+AMP(7))
        AMP2(8)=AMP2(8)+(AMP(8)+AMP(9)+AMP(10)+AMP(11))*DCONJG(AMP(8)
     $   +AMP(9)+AMP(10)+AMP(11))
      ENDIF
