...
C     
      SUBROUTINE FFV9P1N_3(F1, F2, COUP,V3)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      P3(2) = -DIMAG(V3(2))
      P3(3) = -DIMAG(V3(1))
      V3(3)= COUP*(-2D0 * CI)*(P3(1)*(F2(4)*F1(3)+F2(3)*F1(4)+F2(6)
     ...
     $ -F2(6)*F1(5))))
      V3(5)= COUP*(-2D0)*(P3(0)*(F2(4)*F1(3)+F2(6)*F1(5)-F2(3)*F1(4)
     $ -F2(5)*F1(6))+(P3(1)*(-F2(3)*F1(3)-F2(6)*F1(6)+F2(4)*F1(4)+F2(5)
     $ *F1(5))+P3(3)*(F2(4)*F1(3)+F2(3)*F1(4)-F2(6)*F1(5)-F2(5)*F1(6)))
     $ )
      V3(6)= COUP*2D0 * CI*(P3(0)*(F2(3)*F1(3)+F2(5)*F1(5)-F2(4)*F1(4)
