...
C     
     ...
     $ * W3))
      V3(3)= DENOM*2D0 * CI*(OM3*1D0/2D0 * P3(0)*(TMP15-2D0*(TMP17))+(
     $ -1D0/2D0*(F2(5)*F1(3)+F2(6)*F1(4))+F2(3)*F1(5)+F2(4)*F1(6)))
      V3(4)= DENOM*2D0 * CI*(OM3*1D0/2D0 * P3(1)*(TMP15-2D0*(TMP17))+(
     $ +1D0/2D0*(F2(6)*F1(3)+F2(5)*F1(4))+F2(4)*F1(5)+F2(3)*F1(6)))
      V3(5)= DENOM*(-2D0 * CI)*(OM3*1D0/2D0 * P3(2)*(-TMP15+2D0*(TMP17)
     $ )+(-1D0/2D0 * CI*(F2(6)*F1(3))+1D0/2D0 * CI*(F2(5)*F1(4))-CI
     $ *(F2(4)*F1(5))+CI*(F2(3)*F1(6))))
      V3(6)= DENOM*(-2D0 * CI)*(OM3*1D0/2D0 * P3(3)*(-TMP15+2D0*(TMP17)
