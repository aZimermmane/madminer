...
C     Amplitude(s) for diagram number 1
      CALL FFFF10_14_18_19_6_8_0(W(1,4),W(1,5),W(1,1),W(1,2),GC_471
     $ ,GC_589,GC_575,GC_592,GC_150,GC_472,AMP(1))
      CALL FFFF10_14_18_19_6_8_0(W(1,4),W(1,5),W(1,1),W(1,2),GC_473
     $ ,GC_590,GC_576,GC_593,GC_178,GC_474,AMP(2))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_8_3(W(1,1),W(1,2),GC_651,GC_660,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV10_3P0_3(W(1,1),W(1,5),GC_757,GC_754,ZERO, FK_ZERO,W(1,7)
     $ )
C     Amplitude(s) for diagram number 10
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_753,GC_758,AMP(11))
      CALL FFV2_4_3(W(1,1),W(1,5),GC_946,GC_952,MDL_MZ, ZERO,W(1,7))
C     Amplitude(s) for diagram number 11
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_944,GC_951,AMP(12))
C     Amplitude(s) for diagram number 12
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_771,GC_776,AMP(13))
      CALL FFV10_3_3(W(1,1),W(1,5),GC_775,GC_772,MDL_MZ, ZERO,W(1,7))
C     Amplitude(s) for diagram number 13
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_944,GC_951,AMP(14))
C     Amplitude(s) for diagram number 14
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_771,GC_776,AMP(15))
      CALL FFS1_3_3(W(1,1),W(1,5),GC_914,GC_917,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL FFS1_3_0(W(1,4),W(1,2),W(1,7),GC_918,GC_913,AMP(16))
      CALL FFV10_3P0_3(W(1,1),W(1,5),GC_803,GC_800,ZERO, FK_ZERO,W(1,7)
     $ )
C     Amplitude(s) for diagram number 16
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_799,GC_804,AMP(17))
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(1) = AMP(2) +  AMP(5)  ! used 2 times
      TMP_JAMP(2) = TMP_JAMP(1) +  AMP(6)  ! used 2 times
      JAMP(1,1) = AMP(1)+AMP(3)+AMP(4)+AMP(7)+AMP(8)+AMP(9)+AMP(10)+(
     $ -5.000000000000000D-01)*AMP(17)+(-1.666666666666667D-01)
     $ *TMP_JAMP(2)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(11)+(
     $ -1.000000000000000D+00)*AMP(12)+(-1.000000000000000D+00)*AMP(13)
     $ +(-1.000000000000000D+00)*AMP(14)+(-1.000000000000000D+00)
     $ *AMP(15)+(-1.000000000000000D+00)*AMP(16)+(1.666666666666667D
     $ -01)*AMP(17)+(5.000000000000000D-01)*TMP_JAMP(2)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        AMP2(2)=AMP2(2)+(AMP(3)+AMP(4))*DCONJG(AMP(3)+AMP(4))
        AMP2(4)=AMP2(4)+(AMP(5)+AMP(6))*DCONJG(AMP(5)+AMP(6))
        AMP2(6)=AMP2(6)+(AMP(7)+AMP(8)+AMP(9)+AMP(10))*DCONJG(AMP(7)
     $   +AMP(8)+AMP(9)+AMP(10))
        AMP2(10)=AMP2(10)+(AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)
     $   +AMP(16))*DCONJG(AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)
     $   +AMP(16))
