...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO, FK_ZERO,W(1,19)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO, FK_ZERO,W(1,20)) ! count 4
     ...
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,23)) ! count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,24)) ! count 4
     ...
     $    )   *DCONJG(AMP( K,11)+AMP( K,12)+AMP( K,13)+AMP( K,14))
        ENDIF
