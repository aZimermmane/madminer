...
C     Amplitude(s) for diagram number 1
      CALL FFFF11_14_18_19_2_20_6_7_21_110_0(W(1,1),W(1,2),W(1,4),W(1
     $ ,5),GC_205,GC_559,GC_589,GC_579,GC_199,GC_203,GC_149,GC_201
     $ ,GC_204,GC_202,AMP(1))
      CALL FFFF11_14_18_19_2_20_6_7_21_110_0(W(1,1),W(1,2),W(1,4),W(1
     $ ,5),GC_213,GC_560,GC_590,GC_580,GC_207,GC_211,GC_177,GC_209
     $ ,GC_212,GC_210,AMP(2))
...
C     Amplitude(s) for diagram number 10
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_865,GC_748,AMP(11))
C     Amplitude(s) for diagram number 11
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_920,GC_929,AMP(12))
      CALL FFV2_4_3(W(1,1),W(1,5),GC_919,GC_930,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 12
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_865,GC_748,AMP(13))
C     Amplitude(s) for diagram number 13
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_920,GC_929,AMP(14))
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $   +AMP(8)+AMP(9)+AMP(10))
        AMP2(10)=AMP2(10)+(AMP(11)+AMP(12)+AMP(13)+AMP(14))
     $   *DCONJG(AMP(11)+AMP(12)+AMP(13)+AMP(14))
      ENDIF
