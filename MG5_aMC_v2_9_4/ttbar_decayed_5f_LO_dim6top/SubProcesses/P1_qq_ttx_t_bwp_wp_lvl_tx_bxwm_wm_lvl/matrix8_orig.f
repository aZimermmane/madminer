...
C     Amplitude(s) for diagram number 10
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_867,GC_750,AMP(11))
C     Amplitude(s) for diagram number 11
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_922,GC_931,AMP(12))
      CALL FFV2_4_3(W(1,1),W(1,5),GC_921,GC_932,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 12
      CALL FFV10_3_0(W(1,4),W(1,2),W(1,7),GC_867,GC_750,AMP(13))
C     Amplitude(s) for diagram number 13
      CALL FFV2_4_0(W(1,4),W(1,2),W(1,7),GC_922,GC_931,AMP(14))
