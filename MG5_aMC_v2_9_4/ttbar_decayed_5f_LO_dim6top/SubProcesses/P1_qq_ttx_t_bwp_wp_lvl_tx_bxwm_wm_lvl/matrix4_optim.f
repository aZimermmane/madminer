...
C     
      ...
      PARAMETER (NWAVEFUNCS=44, NCOLOR=2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_1(W(1,5),W(1,9),GC_649,MDL_MT, FK_MDL_WT,W(1,10)) ! count 12
      CALL FFV2_1(W(1,6),W(1,9),GC_649,MDL_MT, FK_MDL_WT,W(1,11)) ! count 12
      ...
      CALL FFV2_2(W(1,12),W(1,16),GC_649,MDL_MT, FK_MDL_WT,W(1,17)) ! count 12
      CALL FFV2_2(W(1,13),W(1,16),GC_649,MDL_MT, FK_MDL_WT,W(1,18)) ! count 12
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO, FK_ZERO,W(1,19)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO, FK_ZERO,W(1,20)) ! count 4
      CALL FFV6P1N_1(W(1,10), W(1,19), GC_2, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,3))
      CALL FFV6P1N_1(W(1,10), W(1,20), GC_2, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/17,18/),
     & TMP, W, AMP(1,3))
      CALL FFV6P1N_1(W(1,11), W(1,19), GC_2, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,3))
      CALL FFV6P1N_1(W(1,11), W(1,20), GC_2, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/17,18/),
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_7,ZERO, FK_ZERO,W(1,21)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_7,ZERO, FK_ZERO,W(1,22)) ! count 4
      CALL FFV6P1N_1(W(1,10), W(1,21), GC_7, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,5))
     ...
     & (/17,18/),
     & TMP, W, AMP(1,5))
      CALL FFV6P1N_1(W(1,11), W(1,21), GC_7, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,5))
     ...
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV2_8_3(W(1,1),W(1,4),GC_651,GC_660,MDL_MZ, FK_MDL_WZ,W(1,23)) ! count 4
      CALL FFV2_8_3(W(1,2),W(1,3),GC_651,GC_660,MDL_MZ, FK_MDL_WZ,W(1,24)) ! count 4
      CALL FFV2_8P1N_1(W(1,10), W(1,23), GC_651, GC_660, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,7))
      CALL FFV2_8P1N_1(W(1,10), W(1,24), GC_651, GC_660, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/17,18/),
     & TMP, W, AMP(1,7))
      CALL FFV2_8P1N_1(W(1,11), W(1,23), GC_651, GC_660, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,7))
      CALL FFV2_8P1N_1(W(1,11), W(1,24), GC_651, GC_660, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/17,18/),
     & TMP, W, AMP(1,7)) ! count 1
      DO K = 1, NCOMB
        ...
        TMP_JAMP(1) = AMP( K,2) +  AMP( K,5)  ! used 2 times
        TMP_JAMP(2) = TMP_JAMP(1) +  AMP( K,6)  ! used 2 times
        JAMP(1,1) = AMP( K,1)+AMP( K,3)+AMP( K,4)+AMP( K,7)+AMP( K,8)+AM
     $  P( K,9)+AMP( K,10)+( -5.000000000000000D-01)*AMP( K,17)+(-1.666666666666
     $  667D-01) *TMP_JAMP(2)
        JAMP(2,1) = (-1.000000000000000D+00)*AMP( K,11)+( -1.00000000000
     ...
     $  000000D+00)*AMP( K,16)+(1.666666666666667D -01)*AMP( K,17)+(5.0000000000
     $  00000D-01)*TMP_JAMP(2)
        ...
        IF(SDE_STRAT.EQ.1)THEN
          AMP2(2)=AMP2(2)+(AMP( K,3)+AMP( K,4))*DCONJG(AMP( K,3)+AMP( K,
     $    4))
          AMP2(4)=AMP2(4)+(AMP( K,5)+AMP( K,6))*DCONJG(AMP( K,5)+AMP( K,
     $    6))
          AMP2(6)=AMP2(6)+(AMP( K,7)+AMP( K,8)+AMP( K,9)+AMP( K,10))*DCO
     $    NJG(AMP( K,7)   +AMP( K,8)+AMP( K,9)+AMP( K,10))
          AMP2(10)=AMP2(10)+(AMP( K,11)+AMP( K,12)+AMP( K,13)+AMP( K,14)
     $    +AMP( K,15)   +AMP( K,16))*DCONJG(AMP( K,11)+AMP( K,12)+AMP( K,13)+AMP( 
     $    K,14)+AMP( K,15)   +AMP( K,16))
