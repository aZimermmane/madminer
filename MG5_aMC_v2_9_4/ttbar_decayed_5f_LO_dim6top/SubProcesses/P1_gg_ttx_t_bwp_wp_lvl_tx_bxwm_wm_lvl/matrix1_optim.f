...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3)) ! count 17
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 17
      ...
      CALL FFV2_1(W(1,5),W(1,9),GC_649,MDL_MT, FK_MDL_WT,W(1,10)) ! count 14
      CALL FFV2_1(W(1,6),W(1,9),GC_649,MDL_MT, FK_MDL_WT,W(1,11)) ! count 14
      ...
      CALL FFV2_2(W(1,12),W(1,16),GC_649,MDL_MT, FK_MDL_WT,W(1,17)) ! count 14
      CALL FFV2_2(W(1,13),W(1,16),GC_649,MDL_MT, FK_MDL_WT,W(1,18)) ! count 14
      CALL VVV1P0_1(W(1,1),W(1,3),GC_6,ZERO, FK_ZERO,W(1,19)) ! count 4
      CALL VVV1P0_1(W(1,2),W(1,4),GC_6,ZERO, FK_ZERO,W(1,22)) ! count 4
     ...
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV6_1(W(1,10),W(1,1),GC_7,MDL_MT, ZERO,W(1,27)) ! count 4
      CALL FFV6_1(W(1,10),W(1,2),GC_7,MDL_MT, ZERO,W(1,28)) ! count 4
      CALL FFV6_1(W(1,11),W(1,1),GC_7,MDL_MT, ZERO,W(1,29)) ! count 4
      CALL FFV6_1(W(1,11),W(1,2),GC_7,MDL_MT, ZERO,W(1,30)) ! count 4
     ...
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV6_2(W(1,17),W(1,1),GC_7,MDL_MT, ZERO,W(1,43)) ! count 4
      CALL FFV6_2(W(1,17),W(1,2),GC_7,MDL_MT, ZERO,W(1,44)) ! count 4
      CALL FFV6_2(W(1,18),W(1,1),GC_7,MDL_MT, ZERO,W(1,45)) ! count 4
      CALL FFV6_2(W(1,18),W(1,2),GC_7,MDL_MT, ZERO,W(1,46)) ! count 4
     ...
     & TMP, W, AMP(1,10)) ! count 1
      DO K = 1, NCOMB
        ...
        JAMP(1,1) = AMP( K,4)+AMP( K,5)+AMP( K,6)+AMP( K,7)+AMP( K,8) +(
     $  (0.000000000000000D+00,-1.000000000000000D+00))*TMP_JAMP(2)
        JAMP(2,1) = AMP( K,9)+AMP( K,10)+AMP( K,11)+AMP( K,12)+AMP( K,13
     $  ) +((0.000000000000000D+00,1.000000000000000D+00))*TMP_JAMP(2)
     ...
     $    3))
          AMP2(4)=AMP2(4)+(AMP( K,4)+AMP( K,8))*DCONJG(AMP( K,4)+AMP( K,
     $    8))
          AMP2(5)=AMP2(5)+(AMP( K,5)+AMP( K,6)+AMP( K,7))*DCONJG(AMP( K,
     $    5)+AMP( K,6)   +AMP( K,7))
          AMP2(9)=AMP2(9)+(AMP( K,9)+AMP( K,13))*DCONJG(AMP( K,9)+AMP( K
     $    ,13))
          AMP2(10)=AMP2(10)+(AMP( K,10)+AMP( K,11)+AMP( K,12))*DCONJG(AM
     $    P( K,10)   +AMP( K,11)+AMP( K,12))
        ENDIF
