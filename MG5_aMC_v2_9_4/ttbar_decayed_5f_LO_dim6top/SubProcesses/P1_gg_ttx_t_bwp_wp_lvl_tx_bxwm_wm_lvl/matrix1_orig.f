...
C     Amplitude(s) for diagram number 1
      CALL FFVV2_4_0(W(1,4),W(1,5),W(1,1),W(1,2),GC_728,GC_727,AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_7,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_725,GC_726,AMP(3))
      CALL FFV10_3_1(W(1,5),W(1,1),GC_803,GC_800,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV10_3_0(W(1,4),W(1,7),W(1,2),GC_799,GC_804,AMP(4))
      CALL FFV6_1(W(1,5),W(1,1),GC_7,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL FFV6_0(W(1,4),W(1,7),W(1,2),GC_7,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV11_9_0(W(1,4),W(1,7),W(1,2),GC_725,GC_726,AMP(6))
      CALL FFV11_9_1(W(1,5),W(1,1),GC_725,GC_726,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV6_0(W(1,4),W(1,7),W(1,2),GC_7,AMP(7))
      CALL FFV10_3_1(W(1,5),W(1,1),GC_801,GC_798,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 8
      CALL FFV10_3_0(W(1,4),W(1,7),W(1,2),GC_797,GC_802,AMP(8))
      CALL FFV10_3_2(W(1,4),W(1,1),GC_799,GC_804,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV10_3_0(W(1,7),W(1,5),W(1,2),GC_803,GC_800,AMP(9))
      CALL FFV6_2(W(1,4),W(1,1),GC_7,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV6_0(W(1,7),W(1,5),W(1,2),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV11_9_0(W(1,7),W(1,5),W(1,2),GC_725,GC_726,AMP(11))
      CALL FFV11_9_2(W(1,4),W(1,1),GC_725,GC_726,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 12
      CALL FFV6_0(W(1,7),W(1,5),W(1,2),GC_7,AMP(12))
      CALL FFV10_3_2(W(1,4),W(1,1),GC_797,GC_802,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 13
      CALL FFV10_3_0(W(1,7),W(1,5),W(1,2),GC_801,GC_798,AMP(13))
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(1) = AMP(1) +  AMP(2)  ! used 2 times
      TMP_JAMP(2) = TMP_JAMP(1) +  AMP(3)  ! used 2 times
      JAMP(1,1) = AMP(4)+AMP(5)+AMP(6)+AMP(7)+AMP(8)
     $ +((0.000000000000000D+00,-1.000000000000000D+00))*TMP_JAMP(2)
      JAMP(2,1) = AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)
     $ +((0.000000000000000D+00,1.000000000000000D+00))*TMP_JAMP(2)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(4)=AMP2(4)+(AMP(4)+AMP(8))*DCONJG(AMP(4)+AMP(8))
        AMP2(5)=AMP2(5)+(AMP(5)+AMP(6)+AMP(7))*DCONJG(AMP(5)+AMP(6)
     $   +AMP(7))
