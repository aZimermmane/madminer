...
C     Amplitude(s) for diagram number 1
     ...
     $ -GC_231,-GC_505,-GC_94,-GC_305,AMP(4))
      CALL FFV10_3P0_3(W(1,1),W(1,2),GC_862,GC_857,ZERO, FK_ZERO,W(1,7)
     $ )
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,5),W(1,7),GC_2,AMP(5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,7),GC_813,GC_814,AMP(6))
      CALL FFV2_4_3(W(1,1),W(1,2),GC_943,GC_935,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV10_3_3(W(1,1),W(1,2),GC_782,GC_777,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV10_3_3(W(1,1),W(1,5),GC_747,GC_866,MDL_MW, ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV2_4_3(W(1,1),W(1,5),GC_919,GC_930,MDL_MW, ZERO,W(1,7))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(22)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        AMP2(2)=AMP2(2)+(AMP(5)+AMP(6))*DCONJG(AMP(5)+AMP(6))
        AMP2(4)=AMP2(4)+(AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)+AMP(12)
     $   +AMP(13)+AMP(14))*DCONJG(AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)
     $   +AMP(12)+AMP(13)+AMP(14))
        AMP2(12)=AMP2(12)+(AMP(15)+AMP(16)+AMP(17)+AMP(18)+AMP(19)
     $   +AMP(20)+AMP(21)+AMP(22))*DCONJG(AMP(15)+AMP(16)+AMP(17)
