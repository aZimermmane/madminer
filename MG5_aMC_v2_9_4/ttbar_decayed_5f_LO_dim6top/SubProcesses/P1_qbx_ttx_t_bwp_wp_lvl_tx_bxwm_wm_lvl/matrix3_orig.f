...
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(2)+(5.000000000000000D-01)*AMP(3)+(
     $ -1.666666666666667D-01)*AMP(4)+(-1.000000000000000D+00)*AMP(5)
     ...
     $ +00)*AMP(13)+(-1.000000000000000D+00)*AMP(14)
      JAMP(2,1) = AMP(1)+(-1.666666666666667D-01)*AMP(3)
     $ +(5.000000000000000D-01)*AMP(4)+AMP(15)+AMP(16)+AMP(17)+AMP(18)
