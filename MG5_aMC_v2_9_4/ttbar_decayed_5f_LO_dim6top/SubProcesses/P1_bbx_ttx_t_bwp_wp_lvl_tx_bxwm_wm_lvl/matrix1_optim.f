...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,2),MDL_MB,+1,-1*IC(2),W(1,3)) ! count 15
      CALL OXXXXX(P(0,2),MDL_MB,-1,-1*IC(2),W(1,4)) ! count 15
      CALL OXXXXX(P(0,3),MDL_MB,+1,+1*IC(3),W(1,5)) ! count 1
      CALL OXXXXX(P(0,3),MDL_MB,-1,+1*IC(3),W(1,6)) ! count 1
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,7)) ! count 1
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8)) ! count 1
      CALL FFV2_3(W(1,7),W(1,8),GC_649,MDL_MW, FK_MDL_WW,W(1,9)) ! count 2
      CALL FFV2_1(W(1,5),W(1,9),GC_649,MDL_MT, FK_MDL_WT,W(1,10)) ! count 30
      CALL FFV2_1(W(1,6),W(1,9),GC_649,MDL_MT, FK_MDL_WT,W(1,11)) ! count 30
      CALL IXXXXX(P(0,6),MDL_MB,+1,-1*IC(6),W(1,12)) ! count 1
      CALL IXXXXX(P(0,6),MDL_MB,-1,-1*IC(6),W(1,13)) ! count 1
      CALL OXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,14)) ! count 1
      CALL IXXXXX(P(0,8),ZERO,+1,-1*IC(8),W(1,15)) ! count 1
      CALL FFV2_3(W(1,15),W(1,14),GC_649,MDL_MW, FK_MDL_WW,W(1,16)) ! count 2
      CALL FFV2_2(W(1,12),W(1,16),GC_649,MDL_MT, FK_MDL_WT,W(1,17)) ! count 36
      CALL FFV2_2(W(1,13),W(1,16),GC_649,MDL_MT, FK_MDL_WT,W(1,18)) ! count 36
      CALL FFV6P0_3(W(1,1),W(1,3),GC_1,ZERO, FK_ZERO,W(1,19)) ! count 4
      CALL FFV6P0_3(W(1,1),W(1,4),GC_1,ZERO, FK_ZERO,W(1,20)) ! count 4
      CALL FFV6P0_3(W(1,2),W(1,3),GC_1,ZERO, FK_ZERO,W(1,21)) ! count 4
      CALL FFV6P0_3(W(1,2),W(1,4),GC_1,ZERO, FK_ZERO,W(1,22)) ! count 4
      CALL FFV6P1N_3(W(1,17), W(1,10), GC_2, TMP(1))
      call CombineAmp(4,
     & (/7,3,15,11/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,5))
      CALL FFV6P1N_3(W(1,17), W(1,11), GC_2, TMP(1))
      call CombineAmp(4,
     & (/5,1,13,9/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,5))
      CALL FFV6P1N_3(W(1,18), W(1,10), GC_2, TMP(1))
      call CombineAmp(4,
     & (/8,4,16,12/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,5))
      CALL FFV6P1N_3(W(1,18), W(1,11), GC_2, TMP(1))
      call CombineAmp(4,
     & (/6,2,14,10/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,27)) ! count 4
      CALL FFV2_5_3(W(1,1),W(1,4),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,28)) ! count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,29)) ! count 4
      CALL FFV2_5_3(W(1,2),W(1,4),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,30)) ! count 4
      CALL FFV2_8P1N_3(W(1,17), W(1,10), GC_651, GC_660, TMP(1))
      call CombineAmp(4,
     & (/7,3,15,11/), 
     & (/27,28,29,30/),
     & TMP, W, AMP(1,8))
      CALL FFV2_8P1N_3(W(1,17), W(1,11), GC_651, GC_660, TMP(1))
      call CombineAmp(4,
     & (/5,1,13,9/), 
     & (/27,28,29,30/),
     & TMP, W, AMP(1,8))
      CALL FFV2_8P1N_3(W(1,18), W(1,10), GC_651, GC_660, TMP(1))
      call CombineAmp(4,
     & (/8,4,16,12/), 
     & (/27,28,29,30/),
     & TMP, W, AMP(1,8))
      CALL FFV2_8P1N_3(W(1,18), W(1,11), GC_651, GC_660, TMP(1))
      call CombineAmp(4,
     & (/6,2,14,10/), 
     & (/27,28,29,30/),
     & TMP, W, AMP(1,8)) ! count 1
      CALL FFS4_3(W(1,1),W(1,3),GC_953,MDL_MH, FK_MDL_WH,W(1,43)) ! count 4
      CALL FFS4_3(W(1,2),W(1,4),GC_953,MDL_MH, FK_MDL_WH,W(1,46)) ! count 4
      CALL FFS4P1N_1(W(1,10), W(1,43), GC_954, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/17,18/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,10), W(1,46), GC_954, TMP(1))
      call CombineAmp(2,
     & (/11,12/), 
     & (/17,18/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,11), W(1,43), GC_954, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/17,18/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,11), W(1,46), GC_954, TMP(1))
      call CombineAmp(2,
     & (/9,10/), 
     & (/17,18/),
     & TMP, W, AMP(1,16)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,3),GC_7,ZERO, FK_ZERO,W(1,47)) ! count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_7,ZERO, FK_ZERO,W(1,48)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_7,ZERO, FK_ZERO,W(1,49)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,4),GC_7,ZERO, FK_ZERO,W(1,50)) ! count 4
      CALL FFV6P1N_3(W(1,17), W(1,10), GC_7, TMP(1))
      call CombineAmp(4,
     & (/7,3,15,11/), 
     & (/47,48,49,50/),
     & TMP, W, AMP(1,17))
      CALL FFV6P1N_3(W(1,17), W(1,11), GC_7, TMP(1))
      call CombineAmp(4,
     & (/5,1,13,9/), 
     & (/47,48,49,50/),
     & TMP, W, AMP(1,17))
      CALL FFV6P1N_3(W(1,18), W(1,10), GC_7, TMP(1))
      call CombineAmp(4,
     & (/8,4,16,12/), 
     & (/47,48,49,50/),
     & TMP, W, AMP(1,17))
      CALL FFV6P1N_3(W(1,18), W(1,11), GC_7, TMP(1))
      call CombineAmp(4,
     & (/6,2,14,10/), 
     & (/47,48,49,50/),
     & TMP, W, AMP(1,17)) ! count 1
      CALL FFV2_3(W(1,1),W(1,10),GC_649,MDL_MW, ZERO,W(1,55)) ! count 4
      CALL FFV2_3(W(1,1),W(1,11),GC_649,MDL_MW, ZERO,W(1,56)) ! count 4
      CALL FFV2_3(W(1,2),W(1,10),GC_649,MDL_MW, ZERO,W(1,57)) ! count 4
      CALL FFV2_3(W(1,2),W(1,11),GC_649,MDL_MW, ZERO,W(1,58)) ! count 4
      CALL FFV2P1N_3(W(1,17), W(1,3), GC_649, TMP(1))
      call CombineAmp(4,
     & (/7,5,15,13/), 
     & (/55,56,57,58/),
     & TMP, W, AMP(1,21))
      CALL FFV2P1N_3(W(1,17), W(1,4), GC_649, TMP(1))
      call CombineAmp(4,
     & (/3,1,11,9/), 
     & (/55,56,57,58/),
     & TMP, W, AMP(1,21))
      CALL FFV2P1N_3(W(1,18), W(1,3), GC_649, TMP(1))
      call CombineAmp(4,
     & (/8,6,16,14/), 
     & (/55,56,57,58/),
     & TMP, W, AMP(1,21))
      CALL FFV2P1N_3(W(1,18), W(1,4), GC_649, TMP(1))
      call CombineAmp(4,
     & (/4,2,12,10/), 
     & (/55,56,57,58/),
     & TMP, W, AMP(1,21)) ! count 1
      DO K = 1, NCOMB
        ...
        TMP_JAMP(1) = AMP( K,4) - AMP( K,17)  ! used 2 times
        TMP_JAMP(2) = TMP_JAMP(1) - AMP( K,18)  ! used 2 times
        JAMP(1,1) = (-1.000000000000000D+00)*AMP( K,2)+(-5.0000000000000
     $  00D -01)*AMP( K,3)+AMP( K,5)+AMP( K,6)+AMP( K,7)+AMP( K,8)+AMP( K,9)+AMP
     $  ( K,10)+AMP( K,11) +AMP( K,12)+AMP( K,13)+AMP( K,14)+AMP( K,15)+AMP( K,1
     $  6)+(1.666666666666667D-01) *TMP_JAMP(2)
        JAMP(2,1) = (-1.000000000000000D+00)*AMP( K,1)+(1.66666666666666
     $  7D -01)*AMP( K,3)+(-1.000000000000000D+00)*AMP( K,19)+( -1.0000000000000
     $  00D+00)*AMP( K,20)+(-1.000000000000000D+00)*AMP( K,21) +(-1.000000000000
     $  000D+00)*AMP( K,22)+(-1.000000000000000D+00) *AMP( K,23)+(-1.00000000000
     $  0000D+00)*AMP( K,24)+(-1.000000000000000D +00)*AMP( K,25)+(-5.0000000000
     $  00000D-01)*TMP_JAMP(2)
        ...
        IF(SDE_STRAT.EQ.1)THEN
          AMP2(2)=AMP2(2)+(AMP( K,5)+AMP( K,6)+AMP( K,7))*DCONJG(AMP( K,
     $    5)+AMP( K,6)   +AMP( K,7))
          AMP2(5)=AMP2(5)+(AMP( K,8)+AMP( K,9)+AMP( K,10)+AMP( K,11)+AMP
     $    ( K,12)+AMP( K,13)   +AMP( K,14))*DCONJG(AMP( K,8)+AMP( K,9)+AMP( K,10)+
     $    AMP( K,11)+AMP( K,12)+AMP( K,13)   +AMP( K,14))
          AMP2(12)=AMP2(12)+(AMP( K,15)+AMP( K,16))*DCONJG(AMP( K,15)+AM
     $    P( K,16))
          AMP2(14)=AMP2(14)+(AMP( K,17)+AMP( K,18))*DCONJG(AMP( K,17)+AM
     $    P( K,18))
          AMP2(16)=AMP2(16)+(AMP( K,19)+AMP( K,20)+AMP( K,21)+AMP( K,22)
     $    +AMP( K,23)   +AMP( K,24)+AMP( K,25))*DCONJG(AMP( K,19)+AMP( K,20)+AMP( 
     $    K,21)+AMP( K,22)   +AMP( K,23)+AMP( K,24)+AMP( K,25))
        ENDIF
