...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5)) ! count 16
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6)) ! count 16
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7)) ! count 16
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8)) ! count 16
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO, FK_ZERO,W(1,9)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO, FK_ZERO,W(1,10)) ! count 4
     ...
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,13)) ! count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,14)) ! count 4
