...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5)) ! count 18
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6)) ! count 18
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7)) ! count 18
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8)) ! count 18
      CALL FFFF19P1N_3(W(1,1), W(1,4), W(1,5), GC_593, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFF19P1N_3(W(1,1), W(1,4), W(1,6), GC_593, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO, FK_ZERO,W(1,9)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO, FK_ZERO,W(1,10)) ! count 4
      CALL FFV6P1N_1(W(1,5), W(1,9), GC_2, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,5), W(1,10), GC_2, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,6), W(1,9), GC_2, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,6), W(1,10), GC_2, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_7,ZERO, FK_ZERO,W(1,11)) ! count 8
      CALL FFV1P0_3(W(1,2),W(1,3),GC_7,ZERO, FK_ZERO,W(1,12)) ! count 8
      CALL FFV6P1N_1(W(1,5), W(1,11), GC_7, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
     ...
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFV6P1N_1(W(1,6), W(1,11), GC_7, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
     ...
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFV11P1N_1(W(1,5), W(1,11), GC_725, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,4))
     ...
     & (/7,8/),
     & TMP, W, AMP(1,4))
      CALL FFV11P1N_1(W(1,6), W(1,11), GC_725, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,4))
     ...
     & TMP, W, AMP(1,4)) ! count 1
      CALL FFV2_8_3(W(1,1),W(1,4),-GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,13)) ! count 4
      CALL FFV2_8_3(W(1,2),W(1,3),-GC_650,GC_660,MDL_MZ, FK_MDL_WZ,W(1,14)) ! count 4
      CALL FFV2_8P1N_1(W(1,5), W(1,13), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFV2_8P1N_1(W(1,5), W(1,14), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFV2_8P1N_1(W(1,6), W(1,13), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFV2_8P1N_1(W(1,6), W(1,14), -GC_650, GC_660, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
