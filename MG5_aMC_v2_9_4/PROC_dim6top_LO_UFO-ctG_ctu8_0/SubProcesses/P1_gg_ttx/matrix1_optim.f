...
C     
      ...
      PARAMETER (NWAVEFUNCS=28, NCOLOR=2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WT)
      ...
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5)) ! count 48
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6)) ! count 48
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7)) ! count 48
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8)) ! count 48
      CALL FFVV4P1N_1(W(1,5), W(1,1), W(1,3), GC_727, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFVV4P1N_1(W(1,5), W(1,2), W(1,4), GC_727, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFVV4P1N_1(W(1,6), W(1,1), W(1,3), GC_727, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFVV4P1N_1(W(1,6), W(1,2), W(1,4), GC_727, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL VVV1P0_1(W(1,1),W(1,3),GC_6,ZERO, FK_ZERO,W(1,9)) ! count 8
      CALL VVV1P0_1(W(1,2),W(1,4),GC_6,ZERO, FK_ZERO,W(1,12)) ! count 8
      CALL FFV6P1N_1(W(1,5), W(1,9), GC_7, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,5), W(1,12), GC_7, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,6), W(1,9), GC_7, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV6P1N_1(W(1,6), W(1,12), GC_7, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV11P1N_1(W(1,5), W(1,9), GC_725, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFV11P1N_1(W(1,5), W(1,12), GC_725, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFV11P1N_1(W(1,6), W(1,9), GC_725, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFV11P1N_1(W(1,6), W(1,12), GC_725, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFV6_1(W(1,5),W(1,1),GC_7,MDL_MT, ZERO,W(1,13)) ! count 8
      CALL FFV6_1(W(1,5),W(1,2),GC_7,MDL_MT, ZERO,W(1,14)) ! count 8
      CALL FFV6_1(W(1,6),W(1,1),GC_7,MDL_MT, ZERO,W(1,15)) ! count 8
      CALL FFV6_1(W(1,6),W(1,2),GC_7,MDL_MT, ZERO,W(1,16)) ! count 8
      CALL FFV6P1N_2(W(1,7), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,4))
      CALL FFV6P1N_2(W(1,7), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/11,3,9,1/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,4))
      CALL FFV6P1N_2(W(1,8), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/16,8,14,6/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,4))
      CALL FFV6P1N_2(W(1,8), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/12,4,10,2/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,4)) ! count 1
      CALL FFV11P1N_2(W(1,7), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,5))
      CALL FFV11P1N_2(W(1,7), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/11,3,9,1/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,5))
      CALL FFV11P1N_2(W(1,8), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/16,8,14,6/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,5))
      CALL FFV11P1N_2(W(1,8), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/12,4,10,2/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV11_1(W(1,5),W(1,1),GC_725,MDL_MT, ZERO,W(1,17)) ! count 8
      CALL FFV11_1(W(1,5),W(1,2),GC_725,MDL_MT, ZERO,W(1,18)) ! count 8
      CALL FFV11_1(W(1,6),W(1,1),GC_725,MDL_MT, ZERO,W(1,19)) ! count 8
      CALL FFV11_1(W(1,6),W(1,2),GC_725,MDL_MT, ZERO,W(1,20)) ! count 8
      CALL FFV6P1N_2(W(1,7), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/17,18,19,20/),
     ...
     & TMP, W, AMP(1,7)) ! count 1
      CALL FFV6_2(W(1,7),W(1,1),GC_7,MDL_MT, ZERO,W(1,21)) ! count 8
      CALL FFV6_2(W(1,7),W(1,2),GC_7,MDL_MT, ZERO,W(1,22)) ! count 8
      CALL FFV6_2(W(1,8),W(1,1),GC_7,MDL_MT, ZERO,W(1,23)) ! count 8
      CALL FFV6_2(W(1,8),W(1,2),GC_7,MDL_MT, ZERO,W(1,24)) ! count 8
      CALL FFV6P1N_1(W(1,5), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,8))
      CALL FFV6P1N_1(W(1,5), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/11,3,12,4/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,8))
      CALL FFV6P1N_1(W(1,6), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/13,5,14,6/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,8))
      CALL FFV6P1N_1(W(1,6), W(1,4), GC_7, TMP(1))
      call CombineAmp(4,
     & (/9,1,10,2/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,8)) ! count 1
      CALL FFV11P1N_1(W(1,5), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,9))
      CALL FFV11P1N_1(W(1,5), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/11,3,12,4/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,9))
      CALL FFV11P1N_1(W(1,6), W(1,3), GC_725, TMP(1))
      call CombineAmp(4,
     & (/13,5,14,6/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,9))
      CALL FFV11P1N_1(W(1,6), W(1,4), GC_725, TMP(1))
      call CombineAmp(4,
     & (/9,1,10,2/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,9)) ! count 1
      CALL FFV11_2(W(1,7),W(1,1),GC_725,MDL_MT, ZERO,W(1,25)) ! count 8
      CALL FFV11_2(W(1,7),W(1,2),GC_725,MDL_MT, ZERO,W(1,26)) ! count 8
      CALL FFV11_2(W(1,8),W(1,1),GC_725,MDL_MT, ZERO,W(1,27)) ! count 8
      CALL FFV11_2(W(1,8),W(1,2),GC_725,MDL_MT, ZERO,W(1,28)) ! count 8
      CALL FFV6P1N_1(W(1,5), W(1,3), GC_7, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/25,26,27,28/),
